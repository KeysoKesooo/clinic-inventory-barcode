...
if (isset($_POST['add_product'])) {
    ...
    if (empty($errors)) {
        ...
        $query .= "name, quantity, dosage, description, categorie_id, media_id, date";
        $query .= ") VALUES (";
        $query .= " '{$p_name}', '{$p_qty}', '{$p_dosage}', '{$p_desc}', '{$p_cat}', '{$media_id}', '{$date}'";
        $query .= ")";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="product-dosage"
